...
| week | from | to | groups | topic | activity | do before next week |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|0| 1/10 | 1/14 | group B on campus | ►Review syllabus. ►Introduction to the course. | ►Lecture/slides. ►Jamovi install and general tutorial. ►Students will be directed to the Student Code of Academic Conduct Procedures (ACA-ADM-08) and we will discuss the importance academic integrity. | ►[Jamovi install](https://www.jamovi.org/user-manual.html#installation), and [getting started](https://www.jamovi.org/user-manual.html#getting-started).|
|1| 1/17 | 1/21 | group A on campus | ►Review of basic concepts. ►Instroduction to research proposal. | ►Lecture/slides. ►Ungraded quiz. ►Jamovi install (https://www.jamovi.org)| ►[1.7](https://crumplab.github.io/statistics/why-statistics.html#introduction-to-psychological-measurement) ►[1.8](https://crumplab.github.io/statistics/why-statistics.html#scales-of-measurement) ►[1.10](https://crumplab.github.io/statistics/why-statistics.html#the-role-of-variables-predictors-and-outcomes) ►[1.11](https://crumplab.github.io/statistics/why-statistics.html#experimental-and-non-experimental-research) |
|2| 1/24 | 1/28 | group B on campus | ►Literature searches. | ►Lectures/slides.  ►[Lab 1: Literature searches](pages/lab1_literature_search.html) | ►[Lab 1: Literature searches](pages/lab1_literature_search.html) |
|3| 1/31 | 2/4 | group A on campus | ►Introduction to distributions and data visualization. ►Lab 1 due Tuesday ► Quiz on Tuesday ► Read [2.1](https://crumplab.github.io/statistics/DescribingData.html#this-is-what-too-many-numbers-looks-like) ► Read [2.2](https://crumplab.github.io/statistics/DescribingData.html#look-at-the-data)| ►[Lab 2: Graphing](pages/lab2_visualization.html) | ►[2.3](https://crumplab.github.io/statistics/DescribingData.html#important-ideas-distribution-central-tendency-and-variance), ►[2.4](https://crumplab.github.io/statistics/DescribingData.html#measures-of-central-tendency-sameness) ►[Lab 2: Graphing](pages/lab2_visualization.html)|
|4| 2/7 | 2/11 | group B on campus | ►More visualization and central tendency. ►Lab 2 due Tuesday | Lecture/slides. ►[Lab 3: More graphing](pages/lab3_visualization_more.html) | ►[Lab 3: More graphing](pages/lab3_visualization_more.html) |
|5| 2/14 | 2/18 | group A on campus | ►Variance. ►Lab 3 due Tuesday | ►Lectures/slides. ►[Lab 4: Central Tendency](pages/lab4_central_tendency.html) | ►[Lab 4: Central Tendency](pages/lab4_central_tendency.html) |
|6| 2/21 | 2/25 | group B on campus | ►Introduction to correlations. ►Lab 4 due Tuesday | ►Lecture/slides. ►[Lab 5: Correlation](pages/lab5_correlations.html)| ►Lecture/slides. ►[Lab 5: Correlation](pages/lab5_correlations.html) |
|7| 2/28 | 3/4 | group A on campus | ►Correlations and p-values. ►Lab 5 due Tuesday | ►Lecture/slides. |
|8| 3/7 | 3/11 | group B on campus | ►More correlations and p-values.  ►Research proposal submission 1 due Tuesday | ►Lecture/slides. ►Answering questions about p-values. |
|9| 3/14 | 3/18 | group A on campus | ►Scoring of personality/attitude scales. | ►Lectures/slides ►Data analysis. |
|10| 3/21 | 3/25 | group B on campus | ►One-on-one feedback on research proposal submission 1 | ►One-on-one feedback on research proposal submission 1 |
|--| 3/28 | 4/1  | spring break | spring break | work on research proposal |
|--| 4/4  | 4/8  | spring break | spring break | work on research proposal |
|11| 4/11 | 4/15 | group A on campus | ►Overview of statistical tests: Focus on study design. One-sample and paired-sample t-tests. | ►Lecture/slides. ►[Lab 6: One-sample t-test](pages/lab6_ttests.html) ►[Lab 7: Paired-sample t-test](pages/lab7_ttests.html) | ►[Lab 6: One-sample t-test](pages/lab6_ttests.html) ►[Lab 7: Paired-sample t-test](pages/lab7_ttests.html)|
|12| 4/18 | 4/22 | group B on campus | ►Independent samples t-test and ANOVA. ►Labs 6 and 7 due Tuesday | ►[Lab 8: Independent samples t-test](pages/lab8_ttests.html)  | ►[Lab 8: Independent samples t-test](pages/lab8_ttests.html) |
|13| 4/25 | 4/29 | group A on campus | ►Common mistakes in the interpretation of statistics. ►Lab 8 due Tuesday |  ►Lectures/slides. ►Unmarked data analysis activity examining common pitfalls in interpretation of results. |
|14| 5/2  | 5/6  | group B on campus | ►Exam review ►Research proposals due Thursday | ►Exam review ►Research proposals due Thursday |
|15| 5/9  | 5/13 | group A on campus | ►Exam review | ►Exam review |
